...
class Oshop_CustomRule_Block_Promo_Quote_Edit_Tab_Actions extends Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions {
	...
	protected function _prepareForm()
	{
		...
		$fieldset = $form->addFieldset('action_fieldset', array('legend' => Mage::helper('salesrule')->__('Update prices using the following information nih')));
		$fieldset->addField('simple_action', 'select', array(
            ...
            'options'    => array(
                ...
                Mage_SalesRule_Model_Rule::FIX_FEE => Mage::helper('salesrule')->__('Fix Extra Fee)'), // Add your action
            ),
        ));
